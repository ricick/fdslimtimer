	...
	public class PluginMain : IPlugin
	{
        ...
        */
        ...
        public void InitBasics()
        {
            ...
            //ApplicationFacade.getInstance().SendNotification(ApplicationFacade.APPLICATION_STARTUP);
        }
        /// <summary>
        /// Startup PUREMVC app
        /// </summary>
        ...
        */ 
        ...
        void onTimeoutTimerTick(object sender, EventArgs e)
        {
           log("onTimeoutTimerTick");
            ...
            timer.Stop();
            idle = true;
            ui.setStatusText("Currently idle");
        }
        ...
        private void loadTasks()
        {
           ...
           {
               ui.setStatusText("Error loading tasks for" + username);
        ...
        private void submitTimeEntry()
        {
           ...
           log("duration = " + duration);
            ...
            {
                ui.setStatusText("Error submitting time entry for " + username);
                log("exception.Source : " + exception.Source);
                log("exception.StackTrace : " + exception.StackTrace);
                log("exception.Message : " + exception.Message);
                log("exception.Data : " + exception.Data);
